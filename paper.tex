...
\title{NURM: file-based localization of numerical /differences/ without instrumentation}
...
% Complex neuroimaging pipelines
In neuroimaging, our primary application field, data analyses often consist
of computational pipelines aggregating heterogeneous codes to implement a
specific function. For instance ... 
