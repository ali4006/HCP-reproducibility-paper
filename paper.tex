...
\begin{figure*}
  ...
  \end{subfigure}
    ...
    dashed edges. Every node in the graph is labeled using the name of the executable run by the
...
\begin{minipage}{\linewidth}
  \centering
    ...
    We excluded six more processes in the pipeline for better visualization, including:
