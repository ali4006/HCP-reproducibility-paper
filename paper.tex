...
We exclude processes like [cp, awk, sed, tee, date\dots].}
...
\note{Ali}{The Dataset is: \emph{WU-Minn HCP Data - 1200 Subjects} in the project of 
\emph{HCP 1200 Subject Release}.
There is a group name \emph{S500 Release Subjects} that my data is downloaded from.}
...
\note{Ali}{Image is updated.
I made this figure manually using ImageMagick tool and other scripts that you can find them in 
Consider:/data/asalari/ali-tests/paper\_images/pfs\_fnirt\_imgs.}
