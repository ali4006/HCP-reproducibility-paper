...
are known to impact data analysis pipelines, but it remains difficult to 
\tristan{I will finish this.}
Numerical stability may play a central role in the differences
