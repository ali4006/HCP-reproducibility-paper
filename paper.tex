...
4). The resulting labeled graph identifies the
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=.7\linewidth]{images/p-graph.pdf}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=.7\linewidth]{images/p-graph-dag.pdf}
...
Figure~\ref{fig:iterations} illustrates a hypothetical incremental labeling 
...
as it produces files with differences, and the files produced by \texttt{73\#bet2} in  
Condition 2 are replaced with the files produced by \texttt{73\#bet2} in 
Condition 1. At step 2, process \texttt{75\#fslmaths} is executed and then labeled 
...
\begin{figure}
  \centering
  \includegraphics[width=.8\columnwidth]{images/p-graph-dag-labelled.pdf}
  \caption{Illustration of the labeling approach. Non-reproducible processes are shown in red.}
...
\begin{figure}
  \centering
    \includegraphics[width=\columnwidth]{images/pfs-intransient} 
    \caption{A complete provenance graph from the PreFreesurfer pipeline.
     Full-resolution image is available 
     \href{https://drive.google.com/file/d/1xonnMq4hLEe6GwMp4P7umikvrIAeflDe/view?usp=sharing}{here}.}
...
\begin{figure*}
\centering
  \includegraphics[width=\textwidth]{./data/pfs-20sbj-output/heatmap.png}
