...
\note{Among our dataset, we identified 4 types of subjects with 
different numbers of T1w and T2w images. In addition, we verified that 
the process graphs were identical for all subjects of the same type in 
