...
\begin{figure*} 
   \centering
    ...
    \caption{A complete provenance graph from the PreFreesurfer pipeline. For better visualization, processes associated with commands 
    in \texttt{/bin} or \texttt{/usr/bin} were ommitted, as well as 
...
for a particular subject. Differences appear to be important, in
particular in the areas framed in red.
\begin{figure}
  \centering
