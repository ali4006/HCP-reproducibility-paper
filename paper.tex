...
DAGs produced in the two conditions are then compared, in
...
For this purpose, \toolname measures the distance between process trees using 
the tree edit distance method~\cite{zhang1989simple}, as implemented in 
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=.7\linewidth]{images/p-graph}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=.7\linewidth]{images/p-graph-dag}
...
\begin{figure*}
  ...
  \begin{subfigure}{0.45\linewidth}
    \includegraphics[width=\linewidth]{images/scatter_plot_1.png}
    \caption{Regions with \emph{less} than 10,000 voxels.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.45\linewidth}
    \includegraphics[width=\linewidth]{images/scatter_plot_2.png}
  ...
  \end{subfigure}
    ...
    \caption{Dice coefficients between regions segmented by FreeSurfer in CentOS6 vs CentOS7 (N=20).
        To improve readability, the two graphs are on different y scales.}
