...
current reproducibility crisis. We present \toolname, a tool to identify the
processes in a pipeline that create numerical differences
...
through the \reprozip tool~\cite{rampin2016reprozip}, Spot traverses graphs of processes and
...
\begin{figure*}
  \begin{subfigure}[t]{0.3\linewidth}
    \centering
    \includegraphics[width=.5\linewidth]{images/p-graph.pdf}
  ...
  \begin{subfigure}[t]{0.3\linewidth}
    \centering
    \includegraphics[width=.4\linewidth]{images/p-graph-dag.pdf}
...
\begin{minipage}{\linewidth}
  \centering
    \includegraphics[width=\linewidth]{images/pfs-labeled.png} 
...
\begin{figure}
  \centering
    ...
    CentOS7). An animated version of the comparison is available \href{https://github.com/big-data-lab-team/HCP-reproducibility-paper/blob/master/images/pfs_t2w_alignment.gif}{here}.}
...
propagate widely in the pipelines, and to substantially impact FreeSurfer's
segmentations. This illustrates the need to conduct reproducibility studies
...
Furthermore, as shown in Figure~\ref{fig:pfs_heatmap}, the reproducibility of
...
performed on several subjects. While this is common practice in neurosciences, 
...
registration algorithms. Besides, we plan on using Monte-Carlo arithmetic
to inject controlled amounts of noise in the pipelines, and monitory
uncertainty propagation and amplification in the pipelines.
