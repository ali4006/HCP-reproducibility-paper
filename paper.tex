...
% Pinpointing differences in one condition can be different than other condition.

% add a paragraph to the methods, to explain that the order matters, due to:
% 1. possible differences in the reprozip trace
% 2. the way the comparison is done
}
...
% Also, we used the Pearson correlation coefficient to establish the relationship between Dice value and segmented region size.
...
% This is an average Dice values over 20 subjects for each 44 regions.
}
